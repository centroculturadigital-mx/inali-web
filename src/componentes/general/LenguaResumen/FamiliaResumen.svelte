<script>
  ...
  console.log("HABLANTESSSS::::!!!:: ",lengua.hablantes);
...
<section class="InformacionRelevante">
  <p class="NumeroAgrupaciones">
    ...
    {#if !!lengua.agrupaciones.length}
      {lengua.agrupaciones.length > 1 ? lengua.agrupaciones.length + ' Agrupaciones linguísticas' : lengua.agrupaciones.length + ' Agrupación linguística'}
    {/if}
  </p>
</section>
