<script>
  ...
  const IconoHablantes = `<svg width="20" height="15" viewBox="0 0 32 20" xmlns="http://www.w3.org/2000/svg"><path d="M1.42387 6.29064C1.45353 6.29064 6.79302 7.73935 9.37378 9.10113C11.0053 9.94139 12.3105 10.8975 13.5564 11.8247C13.764 11.9696 13.942 12.1145 14.1497 12.2593L14.209 12.2883C16.7897 14.2296 19.0442 15.939 22.6039 15.997C24.799 16.0549 26.9051 15.2726 28.4773 13.795C30.0495 12.3173 30.9691 10.347 30.9987 8.20293C31.0581 4.8709 29.0409 1.97348 26.1042 0.698611C25.1253 0.292972 24.0574 0.032204 22.9598 0.00322974C20.7647 -0.0547187 18.8365 0.669637 17.5313 1.97348C17.2347 2.29219 16.9677 2.61091 16.7601 2.9586C16.5821 3.27732 16.4338 3.62501 16.3448 4.00167C16.2261 4.49423 16.1371 5.01577 16.1075 5.5373C15.9888 6.5514 16.3151 7.59447 16.9381 8.37678C17.2347 8.75344 17.65 9.10113 18.0653 9.33293C18.5103 9.56472 18.9849 9.70959 19.4892 9.73857C20.4681 9.82549 21.4766 9.56472 22.4259 9.21703L22.7818 9.88344C22.2182 10.1152 21.6843 10.2601 21.1207 10.347C20.5571 10.4339 19.9934 10.4339 19.4002 10.347C18.8366 10.2601 18.2729 10.0573 17.7983 9.76754C17.3237 9.44882 16.6711 8.92729 16.2558 8.28986C15.7812 7.59447 15.5142 6.31961 15.6032 5.36346C15.6329 5.10269 15.6922 4.81295 15.7218 4.55218C14.7726 4.14654 12.7258 3.48014 9.04747 3.59603C6.11075 3.68296 1.42387 5.39243 1.36454 5.39243L0 5.885L1.42387 6.29064Z"/></svg>`;

  let riesgoColor = calculaColorRiesgo(lengua.agrupacionInfo.riesgo);
</script>
...
<section class="InformacionRelevante">
  ...
  <p class="FamiliaPertenece">
    <span style={`fill:#${color}`} class="Hablantes">
      {@html IconoHablantes}
    </span>
    {#if !!lengua.agrupacionId}{lengua.hablantes} Hablantes{/if}
  </p>
  <p class="FamiliaPertenece">
